...
const expectedCandidateResponses = [
  ...
  },
  {
    ...
    method: "GET",
    path: /^\/api\/following$/,
    scenario: "following-identity-inactive",
  },
  {
    status: 401,
    method: "GET",
    path: /^\/api\/following$/,
    scenario: "following-session-expired",
  },
  {
    status: 422,
    method: "POST",
  ...
  },
  {
    ...
    method: "DELETE",
    path: /^\/api\/cart\/items\/[^/]+$/,
    scenario: "guest-cart-delete-conflict",
  },
  {
    status: 409,
    method: "POST",
    path: /^\/api\/orders$/,
    scenario: "guest-cart-order-conflict",
  },
  {
    status: 409,
    method: "GET",
    path: /^\/api\/checkout\/options$/,
    scenario: "guest-cart-checkout-conflict",
  },
  {
    status: 404,
    method: "GET",
    path: /^\/s\/[^/]+\/products\/[^/]+$/,
    scenario: "guest-cart-product-missing",
  },
  {
    status: 404,
    method: "GET",
