CREATE TABLE "store_stores" (
    ...
    CONSTRAINT "store_stores_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "identity_sellers"("id") ON DELETE CASCADE
);
CREATE UNIQUE INDEX "store_stores_seller_id_key" ON "store_stores"("seller_id");
